...
# Presentado por:
# Natalia Rios Agudelo y John Alejandro Obando Gil
#-----------------------------------------------------------------
...
# ------------------------------------------------------------
# 
# Anuncio: Analisis de S&P500 
#
#  Standard & Poor's 500 uno de los indices bursatiles mas importantes     de Estados Unidos que representa la actualidad de las 500 empresas      mas relevantes de la bolsa de New York. Durante los dias 18 de          febrero hasta el 20 de marzo de 2020 sufrio uno de las peores           caidas en muchos años, debido a el paro de la economia por la           pandemia del covid-19, estudiaremos pues, las posibles situaciones      en que podria concluir este problema para aquellos dias.  
#  Se tomaron los datos cada hora durante 22 dias habiles.
#
#-----------------------------------------------------------
...
# Datos de trabajo
# -----------------------------------------------------------------
data = np.genfromtxt(os.path.join(DATA_DIR, "S&P500.tsv"), delimiter="\t")
...
print("antes de eliminar nan", y, " \n ")
print("antes de eliminar nan", x, " \n ")
...
xnan = (list(range(len(x))))


print("y despues de eliminar nan", y, " \n ")
print("x despues de eleminar nan ", xnan, " \n ")
print("x despues de eleminar nan ", x, " \n ")
print("tamaño x despues de eliminar nan:", x.shape, " \n ")
print("tamaño y despues de eliminar nan:", y.shape, " \n ")

x = xnan

print("x despues de igualar xnan ", x, " \n ")
...
def plot_models(x, y, models, fname, mx=None, ymax=None, xmin=None):
    ...
    # Título superior
    plt.title("S&P500 18FEB-20MAR, H1")
    ...
    plt.xticks([ w * 5 * 24 - 24 for w in range(10)],
...
# -----------------------------------------------------------------
#NOTA: El módulo os.path es un submódulo del módulo OS en Python que se utiliza
#para la manipulación de nombres de rutas comunes.
#os.path.join() = Este método concatena varios componentes de ruta con
#exactamente un separador de directorio ('/') después de cada parte no
#vacía excepto el último componente de ruta.

#ejecutamos la funcion creada anteriormente para definir un modelo y
#le pasamos como parametros x, y, no agregamos ningun modelo,
#la ruta donde tenemos el archivo, el nombre del mismo.
plot_models(x, y, None, os.path.join(CHART_DIR, "1400_01_01.png"))

#De esta forma tenemos la primera representacion grafica de
#nuestros datos

# Crea y dibuja los modelos de datos
# -----------------------------------------------------------------
# El método np.polyfit hace un ajuste polinomial de mínimos cuadrados,
#busca la mejor curva que se adapta a ciertos puntos en x & y,
#retorna un vector de coeficientes que minimiza el error cuadrático
#del polinomio.
# full = true:
#Residuals: Devuelve el error de los mínimos cuadrados.
#Rank: El rango de la matriz escalada, los coeficientes escalados de Vandermonde.
#singular_values: los valores singulares de la matriz.
#rcond: Numero condicional del ajuste, los valores que se salen del
#rango no se consideran en la funcion.
...
#llamamos de nuevo la funcion creada anteriormente para definir un modelo
#esta vez lo hacemos para graficar los modelos y vamos agregar cada uno
#de nuestros diferentes modelos creados anteriormente,
#Ahora ubicamos cada modelo(f1,f2,etc) como tercer parametro en nuestra
#funcion plot_models
...
#De esta forma graficamos 3 modelos mas

#Si observamos en la grafica los puntos  que no estan dentro del rango
#de nuestros modelos representan errores, y entre mas alejad, mas
#aumenta la magnitud d enuestro error
#Con cada modelo gragado podemos observar mejores resultados
...
#error: devuelve la diferencia al cuadrado entre el valor de la función y el valor predicho
#np.sum: suma los elementos de matriz sobre un eje dado.
# f es función, cada uno de estos modelos es un tipo de función matemática ligeramente diferente.
#f1,f2,f3,f10 y f100: es una función que tomara una matriz de valores observados (x)
# y devuelve una matriz de valores predichos (y).
...
print(
    "\I Alza o baja 200 pips en la proxima semana %f" % alcanzado_max[0])
