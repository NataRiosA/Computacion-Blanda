...
def plot_models(x, y, models, fname, mx=None, ymax=None, xmin=None):
    ...
    # En este apartado definimos la escala de nuestra grafica
    # definiendo los limites del eje X y del eje Y de la misma grafica
    # Ademas seleccionamos el el estilo de la linea y el color y los guardamos  
